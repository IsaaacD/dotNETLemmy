...
public sealed class LemmyHttpClient : ILemmyHttpClient
{
    ...
    public LemmyHttpClient(HttpClient client) { Client = client; }
    ...
    public Task<BannedPersonsResponse> GetBannedPersons(
        GetBannedPersonsForm form, CancellationToken cancellationToken = default
    ) =>
    ...
    public Task<GetSiteMetadataResponse> GetSiteMetadata(
        GetSiteMetadataForm form, CancellationToken cancellationToken = default
    ) =>
    ...
    public Task<ListCommunitiesResponse> ListCommunities(
        ListCommunitiesForm form, CancellationToken cancellationToken = default
    ) =>
        SendAsync<ListCommunitiesResponse>(form, cancellationToken);

    public Task<ListPostReportsResponse> ListPostReports(
        ListPostReportsForm form, CancellationToken cancellationToken = default
    ) =>
    ...
    public Task<GetCommunityResponse> TransferCommunity(
        TransferCommunityForm form, CancellationToken cancellationToken = default
    ) =>
        SendAsync<GetCommunityResponse>(form, cancellationToken);
